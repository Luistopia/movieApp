...
export function App() {
  ...
  const handleDropdownChange = () => {
    // Aquí puedes manejar el cambio en las opciones del dropdown
  };
      ...
      <div>
        <Navbar bg="dark" variant="dark">
          <Container>
            ...
            <Navbar.Collapse className="justify-content-end" isOpen={isNavOpen}>
              <Nav>
        ...
        <Routes>
          ...
          <Route
            path="/"
            element={<LandingPage onDropdownChange={handleDropdownChange} />}
          />
        </Routes>
      </div>
    </Router>
